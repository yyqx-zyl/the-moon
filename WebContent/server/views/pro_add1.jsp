	...
	<body class="layui-tank">
		 <div class="layui-card">
		 	   <form class="layui-form" action="" id="saveForm">
						    ...
						    <label class="layui-form-label">编号(以数字开头)</label>
						    <div class="layui-input-block">
						        <input type="text" name="mid" lay-verify="mid" autocomplete="off" 
						        value="${empty findemarry ? '':findemarry.mid }" placeholder="" class="layui-input">
						    </div>					    
						</div>
				   <div class="layui-form-item">
					    <label class="layui-form-label">名称</label>
					    <div class="layui-input-block">
					        <input type="text" name="mname" lay-verify="mname" autocomplete="off"
					         value="${empty findemarry ? '':findemarry.mname } " placeholder="" class="layui-input">
					    </div>					    
					</div>
					<div class="layui-form-item layui-form-text">
					    ...
					    <div class="layui-input-block">
					         ...
					         class="layui-textarea" name="mdesc">${empty findemarry ? '':findemarry.mdesc } </textarea>
					    </div>
					</div>
					<div class="layui-form-item layui-form-text">
					    <label class="layui-form-label">价格</label>
					    <div class="layui-input-block">
					         <input type="text" name="mprice" lay-verify="mprice" autocomplete="off" 
					         value=" ${empty findemarry ? '':findemarry.mprice }" placeholder="" class="layui-input">
					    </div>
					</div>
					<div class="layui-form-item layui-form-text">
		 ...
		 <div class=" tkbtnfxd">
		 	<c:if test="${empty findemarry }" var="No">
	...
	//取消
		...
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(add)', function() {
				$.post("${ctx}/addmarry", $("#saveForm").serialize(), function(
						data) {
					// 转换json数据
					console.log(data);
					var res = eval('(' + data + ')');
		...
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(save)', function() {
				$.post("${ctx}/updatemarry", $("#saveForm").serialize(),
						function(data1) {
							console.log(data1);
							// 转换json数据
							//alert(data1);
