...
<html>
	...
	<body class="layui-tank">
		 <div class="layui-card">
		 	  ...
		 	  <div class="layui-form-item">
					    ...
					    <div class="layui-input-block">
					        <input type="text" name="rid" lay-verify="rid" autocomplete="off"
					         value="${empty findereal ? '':findereal.rid } " placeholder="" class="layui-input">
					    </div>					    
					</div>
				   <div class="layui-form-item">
					    <label class="layui-form-label">名称</label>
					    <div class="layui-input-block">
					        <input type="text" name="realname" lay-verify="realname" autocomplete="off"
					         value="${empty findereal ? '':findereal.realname } " placeholder="" class="layui-input">
					    </div>					    
					</div>
					<div class="layui-form-item layui-form-text">
					    ...
					    <div class="layui-input-block">
					         ...
					         class="layui-textarea" name="realdesc">${empty findereal ? '':findereal.realdesc } </textarea>
					    </div>
					</div>
					<div class="layui-form-item layui-form-text">
		 ...
		 <div class=" tkbtnfxd">
		 	<c:if test="${empty findereal }" var="No">
	...
	//取消
		...
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(add)', function() {
				$.post("${ctx}/addreal", $("#saveForm").serialize(), function(
						data) {
					// 转换json数据
					console.log(data);
					var res = eval('(' + data + ')');
		...
		layui.use([ 'form', 'layer' ], function() {
			...
			form.on('submit(save)', function() {
				$.post("${ctx}/updatereal", $("#saveForm").serialize(),
						function(data1) {
							console.log(data1);
							// 转换json数据
							//alert(data1);
