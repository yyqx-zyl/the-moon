	...
	<body class="layui-tank">
		 <div class="layui-card">
		 	   <form class="layui-form" action="" id="saveForm">
						    ...
						    <label class="layui-form-label">编号(以d开头)</label>
						    <div class="layui-input-block">
						        <input type="text" name="pid" lay-verify="pid" autocomplete="off" 
						        value="${empty findedress ? '':findedress.pid }" placeholder="" class="layui-input">
						    </div>					    
						</div>
				   <div class="layui-form-item">
					    <label class="layui-form-label">名称</label>
					    <div class="layui-input-block">
					        <input type="text" name="dname" lay-verify="dname" autocomplete="off"
					         value="${empty findedress ? '':findedress.dname } " placeholder="" class="layui-input">
					    </div>					    
					</div>
					<div class="layui-form-item layui-form-text">
					    ...
					    <div class="layui-input-block">
					         ...
					         class="layui-textarea" name="ddesc">${empty findedress ? '':findedress.ddesc } </textarea>
					    </div>
					</div>
					<div class="layui-form-item layui-form-text">
					    <label class="layui-form-label">价格</label>
					    <div class="layui-input-block">
					         <input type="text" name="dprice" lay-verify="dprice" autocomplete="off" 
					         value=" ${empty findedress ? '':findedress.dprice }" placeholder="" class="layui-input">
					    </div>
					</div>
					<div class="layui-form-item layui-form-text">
		 ...
		 <div class=" tkbtnfxd">
		 	<c:if test="${empty findedress }" var="No">
	...
	layui.use('upload', function(){
		...
		layui.use(['form','layer'],function(){
	        ...
	        form.on('submit(add)',function(){
	        	$.post("${ctx}/adddress",$("#saveForm").serialize(),function(data){
	        		// 转换json数据
					console.log(data);
					var res = eval('('+data+')');
					alert(res.code);
		...
		layui.use(['form','layer'],function(){
			...
			form.on('submit(save)',function(){
					$.post("${ctx}/updatedress",$("#saveForm").serialize(),function(data1){
						console.log(data1);
						// 转换json数据
						//alert(data1);
						var res1 = eval('('+data1+')');
