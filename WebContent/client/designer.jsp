  ...
  <div class="light-wrapper">
    <div class="container inner">
      <div class="row">
        ...
        <ul>
          <li><a href="${ctx}/getdesignerList?currpage=${designer.pageNum-1}">上一页</a></li>
          <c:forEach items="${designer.navigatepageNums }" var="page_Num">
			 ...
			 <c:if test="${page_Num != designer.pageNum }">
			 <li>
			   <a href="${ctx}/getdesignerList?currpage=${page_Num}">${page_Num}</a>
			 </li>
			</c:if>
		</c:forEach>
          <li><a href="${ctx}/getdesignerList?currpage=${designer.pageNum+1}">下一页</a></li>
        </ul>
      </div>
          <!-- /.pagination --> 
